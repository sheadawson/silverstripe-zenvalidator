window.ParsleyExtend=window.ParsleyExtend||{},window.ParsleyExtend=jQuery.extend(window.ParsleyExtend,{asyncSupport:!0,asyncValidators:jQuery.extend({"default":{fn:function(a){return"resolved"===a.state()},url:!1},reverse:{fn:function(a){return"rejected"===a.state()},url:!1}},window.ParsleyExtend.asyncValidators),addAsyncValidator:function(a,b,c,d){return this.asyncValidators[a.toLowerCase()]={fn:b,url:c||!1,options:d||{}},this},asyncValidate:function(){return"ParsleyForm"===this.__class__?this._asyncValidateForm.apply(this,arguments):this._asyncValidateField.apply(this,arguments)},asyncIsValid:function(){return"ParsleyField"===this.__class__?this._asyncIsValidField.apply(this,arguments):this._asyncIsValidForm.apply(this,arguments)},onSubmitValidate:function(a){var b=this;if(!0!==a.parsley)return this.submitEvent=jQuery.extend(!0,{},a),a instanceof jQuery.Event&&(a.stopImmediatePropagation(),a.preventDefault()),this._asyncValidateForm(void 0,a).done(function(){b.submitEvent.isDefaultPrevented()||b.$element.trigger(jQuery.extend(jQuery.Event("submit"),{parsley:!0}))})},eventValidate:function(a){new RegExp("key").test(a.type)&&!this._ui.validationInformationVisible&&this.getValue().length<=this.options.validationThreshold||(this._ui.validatedOnce=!0,this.asyncValidate())},_asyncValidateForm:function(a){var b=this,c=[];this._refreshFields(),jQuery.emit("parsley:form:validate",this);for(var d=0;d<this.fields.length;d++)a&&a!==this.fields[d].options.group||c.push(this.fields[d]._asyncValidateField());return jQuery.when.apply($,c).done(function(){jQuery.emit("parsley:form:success",b)}).fail(function(){jQuery.emit("parsley:form:error",b)}).always(function(){jQuery.emit("parsley:form:validated",b)})},_asyncIsValidForm:function(a,b){var c=[];this._refreshFields();for(var d=0;d<this.fields.length;d++)a&&a!==this.fields[d].options.group||c.push(this.fields[d]._asyncIsValidField(b));return jQuery.when.apply($,c)},_asyncValidateField:function(a){var b=this;return jQuery.emit("parsley:field:validate",this),this._asyncIsValidField(a).done(function(){jQuery.emit("parsley:field:success",b)}).fail(function(){jQuery.emit("parsley:field:error",b)}).always(function(){jQuery.emit("parsley:field:validated",b)})},_asyncIsValidField:function(a,b){var c=jQuery.Deferred();return!1===this.isValid(a,b)?c.rejectWith(this):"undefined"!=typeof this.constraintsByName.remote?this._remote(c):c.resolveWith(this),c.promise()},_remote:function(a){var b,c,d=this,e={},f=this.options.remoteValidator||(!0===this.options.remoteReverse?"reverse":"default");if(f=f.toLowerCase(),"undefined"==typeof this.asyncValidators[f])throw new Error("Calling an undefined async validator: `"+f+"`");e[this.$element.attr("name")||this.$element.attr("id")]=this.getValue(),this.options.remoteOptions=jQuery.extend(!0,this.options.remoteOptions||{},this.asyncValidators[f].options),b=jQuery.extend(!0,{},{url:this.asyncValidators[f].url||this.options.remote,data:e,type:"GET"},this.options.remoteOptions||{}),c=jQuery.param(b),"undefined"==typeof this._remoteCache&&(this._remoteCache={}),this._remoteCache[c]||(this._xhr&&"pending"===this._xhr.state()&&this._xhr.abort(),this._xhr=jQuery.ajax(b),this._remoteCache[c]=this._xhr),this._remoteCache[c].done(function(b,c,e){d._handleRemoteResult(f,e,a)}).fail(function(b,c){"abort"!==c&&d._handleRemoteResult(f,b,a)})},_handleRemoteResult:function(a,b,c){return"function"==typeof this.asyncValidators[a].fn&&this.asyncValidators[a].fn.call(this,b)?void c.resolveWith(this):(this.validationResult=[new window.ParsleyValidator.Validator.Violation(this.constraintsByName.remote,this.getValue(),null)],void c.rejectWith(this))}}),window.ParsleyConfig=window.ParsleyConfig||{},window.ParsleyConfig.validators=window.ParsleyConfig.validators||{},window.ParsleyConfig.validators.remote={fn:function(){return!0},priority:-1},/*!
* Parsleyjs
